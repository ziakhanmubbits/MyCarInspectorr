  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        cache$85 !== index && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    if (null !== lastEffect) {
      ...
      do {
        if ((updateQueue.tag & flags) === flags) {
          lastEffect = void 0;
          var create$100 = updateQueue.create,
            inst = updateQueue.inst;
          lastEffect = create$100();
  ...
  if (flags & 2) {
    try {
      ...
      switch (hostParentFiber.tag) {
        ...
        case 3:
        case 4:
          var parent$103 = hostParentFiber.stateNode.containerInfo,
    ...
    if (0 !== (finishedWork.subtreeFlags & 13878) || root) {
      ...
      try {
        for (nextEffect = finishedWork; null !== nextEffect; ) {
          ...
          if (0 !== (finishedWork.subtreeFlags & 1024) && null !== child)
                  ...
                  if (0 !== (flags & 1024) && null !== current) {
                    ...
                    try {
                      var resolvedPrevProps = resolveClassComponentProps(
                        spawnedLane.type,
                        prevProps,
                        spawnedLane.elementType === spawnedLane.type
                      );
