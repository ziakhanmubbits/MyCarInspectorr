            ...
            for (nextEffect = finishedWork; null !== nextEffect; ) {
              ...
              if (0 !== (finishedWork.subtreeFlags & 1024) && null !== child)
                ...
                a: for (; null !== nextEffect; ) {
                  transitions = finishedWork = nextEffect;
                  var current = transitions.alternate,
                    flags = transitions.flags;
                  switch (transitions.tag) {
                    case 0:
                      break;
                    case 11:
                    case 15:
                    ...
                    case 1:
                      0 !== (flags & 1024) &&
                        null !== current &&
                        commitClassSnapshot(transitions, current);
                      break;
                    case 3:
                      0 !== (flags & 1024) &&
                        transitions.stateNode.containerInfo.children.splice(0);
                      break;
                    case 5:
                    case 26:
                    case 27:
